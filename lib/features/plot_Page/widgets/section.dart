...
class _SectionState extends State<Section> {
        ...
        ...List.generate(
          ...
          (i) => Container(
            ...
            decoration: BoxDecoration(
              border: Border(
                bottom: BorderSide(color: widget.data.colorOscuro, width: 6.0),
              ),
              ...
              onPressed: () {
                ...
                if (options[i + widget.data.startIndex] == 1) {
                  Navigator.of(context).pushNamed(
                    '/Part',
                    arguments: {
                      widget.data.titles[i],
                      widget.data.textForQuest[i],
                    },
                  );
                }
              },
  ...
  Widget visibleButton(int i) {
    ...
    return options[i + widget.data.startIndex] == 1
        ? Text(
          widget.data.titles[i],
          style: TextStyle(
            fontFamily: 'Cinzel',
            color: widget.data.colorOfText,
            fontSize: 11,
          ),
        )
        : Text(
